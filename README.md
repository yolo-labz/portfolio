<picture>
  ...
  <img alt="portfolio: Turborepo monorepo for Next.js portfolio site + 2 mixed-stack project case studies" src="docs/assets/hero-dark.svg">
</picture>
...
| 2 mixed-stack project subfolders (TS + Python)        | yes | no  | no  |
