...
**Use when.** Shipping a portfolio that needs to host multiple capability case-studies (AI document processor source, executive job board, serverless data API) in one monorepo, with a single site deploy surface and design system.
